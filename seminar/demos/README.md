# OMG Seminar Demo Scripts

This directory contains demo scripts for showcasing Oh-My-GeminiCode's capabilities.

## Overview

The seminar includes 5 progressive demos that showcase different aspects of OMG:
...
### Required Setup
- OMG installed and configured (`/oh-my-gemini:omg-setup` completed)
- HUD statusline installed (`/oh-my-gemini:hud setup`)
...
# Verify OMG is installed
which omg || echo "Run: /oh-my-gemini:omg-setup"
...
- [ ] No active OMG operations running (`/oh-my-gemini:cancel --all`)
...
### Opening (1 min)
"Today I'll show you Oh-My-GeminiCode - a multi-agent orchestration system that transforms Gemini from a single assistant into a coordinated team of specialists. Instead of doing everything yourself, you conduct a symphony of AI agents, each optimized for specific tasks."
...
### Closing (1 min)
"OMG transforms how you work with Gemini - from manual coding to orchestrating specialized agents. All open source at github.com/unoShin/oh-my-gemini."

## Tips for Presenters

### General Tips
- **Announce behaviors**: OMG announces what it's activating ("I'm activating autopilot...")
...
- **State cleanup**: Between demos, verify clean state with `/oh-my-gemini:cancel`
...
**Solution**: Jump to next phase or use `/oh-my-gemini:cancel` and show fallback
