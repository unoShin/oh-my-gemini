...
if [ ! -d "$PROJECT_ROOT/dist" ] || [ ! -f "$PROJECT_ROOT/dist/index.js" ]; then
    log_error "oh-my-gemini is not built. Run: npm run build"
    exit 1
fi

log_info "=========================================="
log_info "Running OMG-Enhanced Benchmark"
log_info "=========================================="
log_info "Mode: $RUN_MODE (with oh-my-gemini orchestration)"
...
log_step "Starting OMG-enhanced benchmark run..."
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    log_info "  2. Compare results: python3 compare_results.py --vanilla predictions/vanilla --omg predictions/omg"
    log_info ""
else
    log_error "=========================================="
