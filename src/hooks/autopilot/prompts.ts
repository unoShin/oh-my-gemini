 ...
 * for Gemini to execute. This is the core of the agent invocation mechanism.
 */
...
\`\`\`
Task(
  subagent_type="oh-my-gemini:analyst",
  model="ultra",
...
\`\`\`
Task(
  subagent_type="oh-my-gemini:critic",
  model="ultra",
...
Task(subagent_type="oh-my-gemini:executor-low", model="flash", prompt="...")
...
Task(subagent_type="oh-my-gemini:executor-high", model="ultra", prompt="...")
\`\`\`
...
\`\`\`
Task(
  subagent_type="oh-my-gemini:architect-low",
  model="flash",
...
\`\`\`
Task(
  subagent_type="oh-my-gemini:debugger",
  model="pro",
