...
export type KeywordType =
  ...
  | 'analyze'     // Priority 13
  | 'gemini'       // Priority 15
  | 'ccg';        // Priority 8.5 (Gemini-Gemini-Gemini orchestration)
...
const KEYWORD_PATTERNS: Record<KeywordType, RegExp> = {
  cancel: /\b(cancelomg|stopomg)\b/i,
  ...
  ccg: /\b(ccg|gemini-clix-gemini)\b|(씨씨지)/i,
  gemini: /\b(ask|use|delegate\s+to)\s+(gemini|gpt)\b/i
};
...
const KEYWORD_PRIORITY: KeywordType[] = [
  ...
  'ultrathink', 'deepsearch', 'analyze', 'deep-interview', 'gemini'
];
