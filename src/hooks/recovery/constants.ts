...
/**
 * Get the Gemini Code storage directory
 */
function getGeminiCodeStorageDir(): string {
  return join(getDataDir(), 'gemini-cli', 'storage');
}

export const GEMINI_CODE_STORAGE = getGeminiCodeStorageDir();
export const MESSAGE_STORAGE = join(GEMINI_CODE_STORAGE, 'message');
export const PART_STORAGE = join(GEMINI_CODE_STORAGE, 'part');
