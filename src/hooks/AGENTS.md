...
Hooks intercept Gemini Code events to enable:
...
**Why soft enforcement**: Hard blocking (`continue: false`) would prevent context compaction and could deadlock Gemini Code.
