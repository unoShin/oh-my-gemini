 ...
 * Mirrors OMX assertModeStartAllowed semantics using OMG mode-state-io.
 */
...
/**
 * Start autoresearch mode state using OMG's writeModeState.
 */
...
export function buildAutoresearchInstructions(
  ...
  return [
    '# OMG Autoresearch Supervisor Instructions',
    '',
