 ...
 *
 * Parse JSONL transcript from Gemini Code to extract agents and todos.
...
/**
 * Tools known to require permission approval in Gemini Code.
...
/**
 * Parse a Gemini Code transcript JSONL file.
