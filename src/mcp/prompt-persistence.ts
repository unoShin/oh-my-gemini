 ...
 */
export function getExpectedResponsePath(provider: 'gemini' | 'gemini', slug: string, promptId: string, workingDirectory?: string): string {
 ...
 */
export function getStatusFilePath(provider: 'gemini' | 'gemini', slug: string, promptId: string, workingDirectory?: string): string {
  const promptsDir = getPromptsDir(workingDirectory);
 ...
 */
export function getJobWorkingDir(provider: 'gemini' | 'gemini', jobId: string): string | undefined {
 ...
 */
export function readJobStatus(provider: 'gemini' | 'gemini', slug: string, promptId: string, workingDirectory?: string): JobStatus | undefined {
  ensureJobDb(workingDirectory);
 ...
 */
export function listActiveJobs(provider?: 'gemini' | 'gemini', workingDirectory?: string): JobStatus[] {
  ensureJobDb(workingDirectory);
  // Try SQLite first if available
  if (isJobDbInitialized()) {
