/**
 * Ultra-Optimized Prompt Adaptations
 *
 * Ultra (HIGH tier) prompts are designed for:
...
/**
 * Ultra prompt prefix for enhanced reasoning
 */
export const ULTRA_PROMPT_PREFIX = `<thinking_mode>deep</thinking_mode>
...
/**
 * Ultra prompt suffix for verification
 */
export const ULTRA_PROMPT_SUFFIX = `
...
/**
 * Adapt a base prompt for Ultra execution
 */
export function adaptPromptForUltra(basePrompt: string): string {
  return ULTRA_PROMPT_PREFIX + basePrompt + ULTRA_PROMPT_SUFFIX;
}

/**
 * Ultra-specific delegation template
 */
export const ULTRA_DELEGATION_TEMPLATE = `## HIGH-TIER TASK DELEGATION

**Model**: Gemini Ultra (deep reasoning)
...
/**
 * Ultra debugging template
 */
export const ULTRA_DEBUG_TEMPLATE = `## DEEP DEBUGGING ANALYSIS
...
/**
 * Ultra architecture review template
 */
export const ULTRA_ARCHITECTURE_TEMPLATE = `## ARCHITECTURAL ANALYSIS
