...
// -> tier: HIGH, temperature: 0.7, model: ultra
```
...
// -> tier: HIGH, temperature: 0.3, model: ultra, max thinking
```
...
// -> tier: MEDIUM, temperature: 0.9, model: pro
```
...
// -> tier: LOW, temperature: 0.1, model: flash
```
...
// -> tier: MEDIUM, temperature: 0.5, model: pro
```
