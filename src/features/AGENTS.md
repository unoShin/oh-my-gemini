...
Core feature modules for oh-my-gemini - model routing, state management, verification, and more.

## Purpose

This directory contains self-contained feature modules that enhance orchestration:
- **model-routing/** - Smart routing to Flash/Pro/Ultra based on task complexity
...
const model = routeToModel(signals); // 'flash' | 'pro' | 'ultra'
```
