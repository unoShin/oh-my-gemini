...
This module provides a single source of truth for verification requirements and execution across all major OMG workflows. It standardizes the verification process and ensures consistent evidence collection.
...
if (checklist.summary?.verdict === 'approved') {
  ...
  console.log('[RALPH VERIFIED] Run /oh-my-gemini:cancel to exit.');
}
```
