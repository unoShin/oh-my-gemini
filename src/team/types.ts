...
export interface TaskModeMap {
  teamName: string;
  taskModes: Record<string, 'mcp_gemini' | 'gemini_worker'>;
}
...
/** Worker backend type */
export type WorkerBackend = 'gemini-native' | 'mcp-gemini' | 'tmux-gemini';
