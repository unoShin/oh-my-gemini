 ...
 * - Gemini native members: returns instruction for SendMessage tool
 ...
 * - Gemini native: returns instruction to use SendMessage tool
...
export function routeMessage(
  ...
  if (member.backend === 'gemini-native') {
    return {
      method: 'native',
  ...
  const teamsBase = join(getGeminiConfigDir(), 'teams');
 ...
 * - Gemini native: returns list for SendMessage broadcast
