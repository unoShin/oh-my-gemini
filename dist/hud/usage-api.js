    ...
    try {
        ...
        if (cache.data) {
            ...
            if (cache.data.proWeeklyResetsAt) {
                cache.data.proWeeklyResetsAt = new Date(cache.data.proWeeklyResetsAt);
            }
            if (cache.data.ultraWeeklyResetsAt) {
                cache.data.ultraWeeklyResetsAt = new Date(cache.data.ultraWeeklyResetsAt);
            }
...
export async function getUsage() {
    ...
    const currentSource = isZai && authToken ? 'zai' : 'gemini';
