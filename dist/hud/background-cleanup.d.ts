 ...
 */
export declare function cleanupStaleBackgroundTasks(thresholdMs?: number, directory?: string): Promise<number>;
/**
 ...
 */
export declare function detectOrphanedTasks(directory?: string): Promise<BackgroundTask[]>;
/**
 * Mark orphaned tasks as stale/completed to clean up the display.
 *
 * @returns Number of tasks marked
 */
export declare function markOrphanedTasksAsStale(directory?: string): Promise<number>;
