        ...
        try {
            ...
            if (settings.omgHud) {
                return mergeWithDefaults({
                    ...legacyConfig,
                    ...settings.omgHud,
                    elements: mergeElements(legacyConfig?.elements, settings.omgHud.elements),
                    thresholds: mergeThresholds(legacyConfig?.thresholds, settings.omgHud.thresholds),
                    contextLimitWarning: mergeContextLimitWarning(legacyConfig?.contextLimitWarning, settings.omgHud.contextLimitWarning),
                    missionBoard: mergeMissionBoardConfig(legacyConfig?.missionBoard, settings.omgHud.missionBoard),
                });
            }
        }
        catch (error) {
