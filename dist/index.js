...
import { omgToolsServer, getOmgToolNames } from './mcp/omg-tools-server.js';
...
REPO_OWNER, REPO_NAME, GITHUB_API_URL, GEMINI_CONFIG_DIR, VERSION_FILE, 
...
export { isGptModel, isGeminiModel, getDefaultModelForCategory, 
// Utilities
...
// Installer exports
export { install, isInstalled, getInstallInfo, isGeminiInstalled, GEMINI_CONFIG_DIR as INSTALLER_GEMINI_CONFIG_DIR, AGENTS_DIR, COMMANDS_DIR, VERSION as INSTALLER_VERSION } from './installer/index.js';
/**
 ...
 * ```
 */
export function createOmgSession(options) {
    // Load configuration
    ...
    // Build system prompt
    let systemPrompt = omgSystemPrompt;
 ...
 */
export function getOmgSystemPrompt(options) {
    let prompt = omgSystemPrompt;
