...
const DEFAULT_CAPABILITIES = {
    'gemini-native': ['code-edit', 'testing', 'general'],
    'mcp-gemini': ['code-review', 'security-review', 'architecture', 'refactoring', 'ui-design', 'documentation', 'research', 'code-edit'],
    'tmux-gemini': ['code-edit', 'testing', 'general', 'code-review', 'security-review', 'architecture', 'refactoring', 'ui-design', 'documentation', 'research'],
};
/**
