 ...
 */
export declare function registerMcpWorker(teamName: string, workerName: string, provider: string, model: string, tmuxTarget: string, cwd: string, workingDirectory: string): void;
/**
