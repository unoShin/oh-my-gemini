...
export function generateTriggerMessage(teamName, workerName, teamStateRoot = '.omg/state') {
...
export function generateMailboxTriggerMessage(teamName, workerName, count = 1, teamStateRoot = '.omg/state') {
