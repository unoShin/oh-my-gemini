 ...
 *
 * Provides four tools for managing background Gemini/Gemini jobs:
 ...
 */
export declare function findJobStatusFile(provider: 'gemini' | 'gemini', jobId: string, workingDirectory?: string): {
    statusPath: string;
    slug: string;
} | undefined;
/**
 ...
 */
export declare function handleWaitForJob(provider: 'gemini' | 'gemini', jobId: string, timeoutMs?: number): Promise<{
    content: Array<{
        type: 'text';
        text: string;
    }>;
 ...
 */
export declare function handleCheckJobStatus(provider: 'gemini' | 'gemini', jobId: string): Promise<{
    content: Array<{
        type: 'text';
        text: string;
    }>;
 ...
 * kill_job - send a signal to a running background job
 */
export declare function handleKillJob(provider: 'gemini' | 'gemini', jobId: string, signal?: string): Promise<{
    content: Array<{
        type: 'text';
        text: string;
    }>;
 ...
 */
export declare function handleListJobs(provider: 'gemini' | 'gemini', statusFilter?: 'active' | 'completed' | 'failed' | 'all', limit?: number): Promise<{
    content: Array<{
        type: 'text';
        text: string;
    }>;
...
export declare function getJobManagementToolSchemas(_provider?: 'gemini' | 'gemini'): ({
    name: string;
    description: string;
    inputSchema: {
        type: "object";
