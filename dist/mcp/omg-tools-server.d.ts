 ...
 */
export declare const omgToolsServer: {};
/**
 ...
 */
export declare const omgToolNames: string[];
/**
 * Get tool names filtered by category.
 * Uses category metadata instead of string heuristics.
 */
export declare function getOmgToolNames(options?: {
    includeLsp?: boolean;
    includeAst?: boolean;
...
//# sourceMappingURL=omg-tools-server.d.ts.map