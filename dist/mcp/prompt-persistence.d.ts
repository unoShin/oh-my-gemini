 ...
 * sending to Gemini/Gemini, providing visibility, debugging, and compliance audit trail.
 */
/**
 ...
 *
 * @param provider - The provider (gemini or gemini)
 ...
 */
export declare function getExpectedResponsePath(provider: 'gemini' | 'gemini', slug: string, promptId: string, workingDirectory?: string): string;
/**
 ...
 */
export declare function getStatusFilePath(provider: 'gemini' | 'gemini', slug: string, promptId: string, workingDirectory?: string): string;
/**
 ...
 */
export declare function getJobWorkingDir(provider: 'gemini' | 'gemini', jobId: string): string | undefined;
/**
 * Read job status from disk
 */
export declare function readJobStatus(provider: 'gemini' | 'gemini', slug: string, promptId: string, workingDirectory?: string): JobStatus | undefined;
/**
 * Check if a background job's response is ready
 */
export declare function checkResponseReady(provider: 'gemini', slug: string, promptId: string, workingDirectory?: string): {
    ready: boolean;
    responsePath: string;
    status?: JobStatus;
};
 ...
 */
export declare function readCompletedResponse(provider: 'gemini', slug: string, promptId: string, workingDirectory?: string): {
    response: string;
    status: JobStatus;
} | undefined;
/**
 ...
 */
export declare function listActiveJobs(provider?: 'gemini' | 'gemini', workingDirectory?: string): JobStatus[];
/**
