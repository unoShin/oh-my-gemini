 ...
 */
export function getOmgRoot(worktreeRoot) {
 ...
 */
export function resolveOmgPath(relativePath, worktreeRoot) {
 ...
 */
export function ensureOmgDir(relativePath, worktreeRoot) {
 ...
 */
export function isPathUnderOmg(absolutePath, worktreeRoot) {
 ...
 */
export function ensureAllOmgDirs(worktreeRoot) {
    const omgRoot = getOmgRoot(worktreeRoot);
