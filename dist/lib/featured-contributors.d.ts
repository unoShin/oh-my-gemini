export declare const FEATURED_CONTRIBUTORS_START_MARKER = "<!-- OMG:FEATURED-CONTRIBUTORS:START -->";
export declare const FEATURED_CONTRIBUTORS_END_MARKER = "<!-- OMG:FEATURED-CONTRIBUTORS:END -->";
