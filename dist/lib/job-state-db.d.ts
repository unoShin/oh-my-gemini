/**
 * Job State Database - SQLite-based persistent state for Gemini/Gemini background jobs
 *
 ...
 */
export declare function getJob(provider: "gemini", jobId: string, cwd?: string): JobStatus | null;
/**
 ...
 */
export declare function getJobsByStatus(provider: "gemini" | "gemini" | undefined, status: string, cwd?: string): JobStatus[];
/**
 ...
 */
export declare function getActiveJobs(provider?: "gemini", cwd?: string): JobStatus[];
/**
 ...
 */
export declare function getRecentJobs(provider?: "gemini", withinMs?: number, cwd?: string): JobStatus[];
/**
 ...
 */
export declare function updateJobStatus(provider: "gemini", jobId: string, updates: Partial<JobStatus>, cwd?: string): boolean;
/**
 ...
 */
export declare function deleteJob(provider: "gemini", jobId: string, cwd?: string): boolean;
/**
