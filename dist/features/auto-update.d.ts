...
export declare const REPO_OWNER = "unoShin";
export declare const REPO_NAME = "oh-my-gemini";
export declare const GITHUB_API_URL = "https://api.github.com/repos/unoShin/oh-my-gemini";
export declare const GITHUB_RAW_URL = "https://raw.githubusercontent.com/unoShin/oh-my-gemini";
 ...
 */
export declare function getOMGConfig(): OMGConfig;
/**
