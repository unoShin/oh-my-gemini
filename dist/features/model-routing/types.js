 ...
 * sub-agent tasks to appropriate models (Ultra/Pro/Flash) based on
 * task complexity.
 */
import { getDefaultTierModels } from '../../config/models.js';
/**
 * Model tier mapping to actual Gemini models.
 *
 * Reads from environment variables (OMG_MODEL_HIGH, OMG_MODEL_MEDIUM,
 * OMG_MODEL_LOW) with built-in fallbacks. User/project config overrides
