...
function selectAgentType(component) {
    const roleToAgent = {
        frontend: 'oh-my-gemini:designer',
        backend: 'oh-my-gemini:executor',
        database: 'oh-my-gemini:executor',
        api: 'oh-my-gemini:executor',
        ui: 'oh-my-gemini:designer',
        shared: 'oh-my-gemini:executor',
        testing: 'oh-my-gemini:qa-tester',
        docs: 'oh-my-gemini:writer',
        config: 'oh-my-gemini:executor',
        module: 'oh-my-gemini:executor'
    };
    return roleToAgent[component.role] || 'oh-my-gemini:executor';
}
