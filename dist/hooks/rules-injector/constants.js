...
export const OMG_STORAGE_DIR = join(homedir(), '.omg');
export const RULES_INJECTOR_STORAGE = join(OMG_STORAGE_DIR, 'rules-injector');
...
export const USER_RULE_DIR = '.gemini/rules';
