...
describe('session-replay', () => {
    ...
    describe('event helpers', () => {
        it('recordAgentStart should record start event', () => {
            recordAgentStart(testDir, 'sess3', 'agent-123', 'oh-my-gemini:executor', 'Fix the bug', 'ultrawork', 'pro');
        ...
        it('recordAgentStop should record stop event', () => {
            recordAgentStop(testDir, 'sess4', 'agent-456', 'oh-my-gemini:architect', true, 5000);
