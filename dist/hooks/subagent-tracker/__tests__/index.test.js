...
describe("subagent-tracker", () => {
                ...
                agents: [
                    {
                        ...
                        agent_type: "oh-my-gemini:executor",
    ...
    describe("getAgentDashboard", () => {
        ...
        it("should show tool count and last tool", () => {
            const state = {
                agents: [
                    {
                        agent_id: "test-123",
                        agent_type: "oh-my-gemini:architect",
                        started_at: new Date().toISOString(),
                        parent_mode: "none",
                        status: "running",
                        tool_usage: [
        ...
        it("should strip oh-my-gemini: prefix from agent type", () => {
            const state = {
                agents: [
                    {
                        agent_id: "test-123",
                        agent_type: "oh-my-gemini:architect-high",
                        started_at: new Date().toISOString(),
                        parent_mode: "none",
                        status: "running",
                    },
            ...
            expect(dashboard).not.toContain("oh-my-gemini:architect-high");
        });
    });
        ...
        it("should detect file conflicts between agents", () => {
            const state = {
                agents: [
                    ...
                    {
                        agent_id: "agent-2",
                        agent_type: "oh-my-gemini:designer",
                        started_at: new Date().toISOString(),
                        parent_mode: "ultrawork",
                        status: "running",
