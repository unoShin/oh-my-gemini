/**
 * Hooks Module for Oh-My-GeminiCode
 *
 * This module provides the TypeScript bridge for Gemini Code's native shell hook system.
 * Shell scripts call these TypeScript functions for complex logic processing.
 *
 * Architecture:
 * - Gemini Code runs shell scripts on hook events (UserPromptSubmit, Stop, etc.)
 * - Shell scripts invoke Node.js bridge for complex processing
 * - Bridge returns JSON response that shell passes back to Gemini Code
 */
export { 
// Keyword detection
...
readPrd, writePrd, findPrdPath, getPrdPath, getOmgPrdPath, getPrdStatus, markStoryComplete, markStoryIncomplete, getStory, getNextStory, createPrd, createSimplePrd, initPrd, formatPrdStatus, formatStory, formatPrd, formatNextStoryPrompt, PRD_FILENAME, PRD_EXAMPLE_FILENAME, 
// Progress (Memory Persistence)
readProgress, readProgressRaw, parseProgress, findProgressPath, getProgressPath, getOmgProgressPath, initProgress, appendProgress, addPattern, getPatterns, getRecentLearnings, formatPatternsForContext, formatProgressForContext, formatLearningsForContext, getProgressContext, PROGRESS_FILENAME, PATTERNS_HEADER, ENTRY_SEPARATOR, 
...
export { 
// OMG Orchestrator
createOmgOrchestratorHook, isAllowedPath, isWriteEditTool, getGitDiffStats, formatFileChanges, buildVerificationReminder, buildOrchestratorReminder, buildBoulderContinuation, checkBoulderContinuation, processOrchestratorPreTool, processOrchestratorPostTool, HOOK_NAME as OMG_ORCHESTRATOR_HOOK_NAME, ALLOWED_PATH_PREFIX, WRITE_EDIT_TOOLS, DIRECT_WORK_REMINDER, ORCHESTRATOR_DELEGATION_REQUIRED, BOULDER_CONTINUATION_PROMPT, VERIFICATION_REMINDER, SINGLE_TASK_DIRECTIVE } from './omg-orchestrator/index.js';
export { 
// Auto Slash Command
...
processCodeSimplifier, isCodeSimplifierEnabled, getModifiedFiles, readOmgConfig, isAlreadyTriggered, writeTriggerMarker, clearTriggerMarker, buildSimplifierMessage, TRIGGER_MARKER_FILENAME, } from './code-simplifier/index.js';
