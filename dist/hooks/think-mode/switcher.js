 ...
 */
import { GEMINI_FAMILY_DEFAULTS, GEMINI_FAMILY_HIGH_VARIANTS, getGeminiHighVariantFromModel, } from '../../config/models.js';
/**
 ...
 */
export function getGeminiThinkingConfig(budgetTokens = 64000) {
    return {
        thinking: {
            type: 'enabled',
            budgetTokens,
