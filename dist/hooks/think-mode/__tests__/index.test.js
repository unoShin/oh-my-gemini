...
// Switcher functions
getHighVariant, isAlreadyHighVariant, getThinkingConfig, getGeminiThinkingConfig, THINKING_CONFIGS, 
// State management
...
World`);
    ...
    describe('switcher - getHighVariant', () => {
        describe('Gemini models', () => {
            it('should return high variant for gemini-pro-4-6', () => {
                expect(getHighVariant('gemini-pro-4-6')).toBe('gemini-pro-4-6-high');
            });
            it('should return high variant for gemini-ultra-4-6', () => {
                expect(getHighVariant('gemini-ultra-4-6')).toBe('gemini-ultra-4-6-high');
            });
            it('should return high variant for gemini-3-5-pro', () => {
                expect(getHighVariant('gemini-3-5-pro')).toBe('gemini-pro-4-6-high');
            });
            it('should return high variant for gemini-3-ultra', () => {
                expect(getHighVariant('gemini-3-ultra')).toBe('gemini-ultra-4-6-high');
            });
            it('should handle version with dot notation', () => {
                expect(getHighVariant('gemini-pro-4.5')).toBe('gemini-pro-4-6-high');
            });
        });
        describe('GPT models', () => {
        ...
        describe('Already high variants', () => {
            it('should return null for already high variant', () => {
                expect(getHighVariant('gemini-pro-4-6-high')).toBeNull();
            });
        ...
        describe('Prefixed models', () => {
            it('should preserve prefix in high variant', () => {
                expect(getHighVariant('vertex_ai/gemini-pro-4-5')).toBe('vertex_ai/gemini-pro-4-6-high');
            });
    ...
    describe('switcher - isAlreadyHighVariant', () => {
        it('should return true for high variant models', () => {
            expect(isAlreadyHighVariant('gemini-pro-4-6-high')).toBe(true);
        });
        ...
        it('should return false for non-high variant', () => {
            expect(isAlreadyHighVariant('gemini-pro-4-6')).toBe(false);
        });
        it('should handle prefixed models', () => {
            expect(isAlreadyHighVariant('vertex_ai/gemini-pro-4-6-high')).toBe(true);
            expect(isAlreadyHighVariant('vertex_ai/gemini-pro-4-6')).toBe(false);
        });
        it('should normalize dot notation', () => {
            expect(isAlreadyHighVariant('gemini-pro-4.5-high')).toBe(true);
        });
    });
    describe('switcher - getThinkingConfig', () => {
        describe('Anthropic provider', () => {
            it('should return config for Gemini models', () => {
                const config = getThinkingConfig('anthropic', 'gemini-pro-4-6');
                expect(config).not.toBeNull();
                expect(config).toHaveProperty('thinking');
            });
            it('should return null for already high variant', () => {
                const config = getThinkingConfig('anthropic', 'gemini-pro-4-6-high');
                expect(config).toBeNull();
            });
        });
        describe('Amazon Bedrock provider', () => {
            it('should return config for Gemini models on Bedrock', () => {
                const config = getThinkingConfig('amazon-bedrock', 'anthropic.gemini-3-pro');
                expect(config).not.toBeNull();
        ...
        describe('GitHub Copilot proxy', () => {
            it('should resolve to anthropic for Gemini model', () => {
                const config = getThinkingConfig('github-copilot', 'gemini-pro-4-6');
                expect(config).not.toBeNull();
                expect(config).toHaveProperty('thinking');
            });
    ...
    describe('switcher - getGeminiThinkingConfig', () => {
        ...
        it('should accept custom budget tokens', () => {
            const config = getGeminiThinkingConfig(32000);
    ...
    describe('createThinkModeHook', () => {
        ...
        describe('processChatParams', () => {
                ...
                const input = {
                    ...
                    message: {
                        model: {
                            ...
                            modelId: 'gemini-pro-4-6',
                        },
                    },
                };
                const state = hook.processChatParams('test-session', input);
                expect(state.modelSwitched).toBe(true);
                expect(input.message.model?.modelId).toBe('gemini-pro-4-6-high');
            });
            ...
            it('should store provider and model in state', () => {
                ...
                expect(state?.modelId).toBe('gemini-pro-4-6');
            });
        });
