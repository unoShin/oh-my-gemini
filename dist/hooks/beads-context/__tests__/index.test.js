...
vi.mock('../../../features/auto-update.js', () => ({
    getOMGConfig: vi.fn(() => ({ silentAutoUpdate: false })),
}));
...
const mockGetOMGConfig = vi.mocked(getOMGConfig);
...
describe('beads-context', () => {
    beforeEach(() => {
        vi.clearAllMocks();
        mockGetOMGConfig.mockReturnValue({ silentAutoUpdate: false });
    });
    ...
    describe('getBeadsContextConfig', () => {
        ...
        it('should read taskTool from config', () => {
            mockGetOMGConfig.mockReturnValue({
