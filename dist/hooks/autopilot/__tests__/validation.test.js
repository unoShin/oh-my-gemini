...
describe('AutopilotValidation', () => {
    ...
    describe('getValidationSpawnPrompt', () => {
        it('should return prompt with spec path', () => {
            ...
            expect(prompt).toContain('oh-my-gemini:architect');
            expect(prompt).toContain('oh-my-gemini:security-reviewer');
            expect(prompt).toContain('oh-my-gemini:code-reviewer');
        });
        ...
        it('should specify model as ultra', () => {
            const prompt = getValidationSpawnPrompt('/spec.md');
            const ultraMatches = prompt.match(/model="ultra"/g);
            expect(ultraMatches).toHaveLength(3);
        });
