 ...
 *
 * The script's cleanup block scans ~/.gemini/plugins/cache/omg/oh-my-gemini/
 ...
 * "Cannot find module" errors when a running session's GEMINI_PLUGIN_ROOT
...
describe('session-start.mjs — plugin cache cleanup uses symlinks', () => {
    ...
    beforeEach(() => {
        ...
        fakeCacheBase = join(fakeHome, '.gemini', 'plugins', 'cache', 'omg', 'oh-my-gemini');
        ...
        try {
            const result = execFileSync(NODE, [SCRIPT_PATH], {
                ...
                env: {
                    ...
                    GEMINI_PLUGIN_ROOT: join(fakeCacheBase, '4.4.3'),
                    ...env,
                },
                timeout: 15000,
            });
