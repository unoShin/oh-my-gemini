...
vi.mock('../../lib/worktree-paths.js', async () => {
    ...
    return {
        ...
        getOmgRoot: (dir) => join(dir || testDir, '.omg'),
    };
});
describe('trace-tools', () => {
    ...
    describe('agent breakdown in summary', () => {
        it('should show agent breakdown with type counts and models', async () => {
            appendReplayEvent(testDir, 'bd-sess', { agent: 'a1', event: 'agent_start', agent_type: 'planner', model: 'ultra' });
            appendReplayEvent(testDir, 'bd-sess', { agent: 'a1', event: 'agent_stop', agent_type: 'planner', success: true, duration_ms: 45000 });
            appendReplayEvent(testDir, 'bd-sess', { agent: 'a2', event: 'agent_start', agent_type: 'critic', model: 'ultra' });
            appendReplayEvent(testDir, 'bd-sess', { agent: 'a2', event: 'agent_stop', agent_type: 'critic', success: true, duration_ms: 30000 });
            appendReplayEvent(testDir, 'bd-sess', { agent: 'a3', event: 'agent_start', agent_type: 'planner', model: 'ultra' });
            appendReplayEvent(testDir, 'bd-sess', { agent: 'a3', event: 'agent_stop', agent_type: 'planner', success: true, duration_ms: 38000 });
            appendReplayEvent(testDir, 'bd-sess', { agent: 'a4', event: 'agent_start', agent_type: 'critic', model: 'ultra' });
        ...
        it('should show execution flow section', async () => {
            ...
            appendReplayEvent(testDir, 'flow-exec', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-gemini:plan' });
            appendReplayEvent(testDir, 'flow-exec', { agent: 'a1', event: 'agent_start', agent_type: 'planner', model: 'ultra' });
            ...
            expect(text).toContain('oh-my-gemini:plan invoked');
    ...
    describe('skills_invoked in summary', () => {
        it('should show skills invoked via Skill tool', async () => {
            appendReplayEvent(testDir, 'sk-sess', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-gemini:plan' });
            appendReplayEvent(testDir, 'sk-sess', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-gemini:ultrawork' });
            ...
            expect(text).toContain('oh-my-gemini:plan');
            expect(text).toContain('oh-my-gemini:ultrawork');
        });
        it('should format skill_invoked in timeline', async () => {
            appendReplayEvent(testDir, 'sk-tl', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-gemini:plan' });
        ...
        it('should include skill_invoked in skills filter', async () => {
            appendReplayEvent(testDir, 'sk-flt', { agent: 'system', event: 'skill_invoked', skill_name: 'oh-my-gemini:plan' });
