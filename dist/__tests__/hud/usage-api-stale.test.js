...
const GEMINI_CONFIG_DIR = '/tmp/test-gemini';
const CACHE_PATH = `${GEMINI_CONFIG_DIR}/plugins/oh-my-gemini/.usage-cache.json`;
const CACHE_DIR = `${GEMINI_CONFIG_DIR}/plugins/oh-my-gemini`;
function createFsMock(initialFiles) {
    const files = new Map(Object.entries(initialFiles));
    const directories = new Set([GEMINI_CONFIG_DIR, CACHE_DIR]);
...
function setupMocks(fsModule, httpStatus, httpBody) {
    vi.doMock('../../utils/paths.js', () => ({
        getGeminiConfigDir: () => GEMINI_CONFIG_DIR,
    }));
