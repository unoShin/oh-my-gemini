...
import { validateUrlForSSRF, validateGeminiBaseUrl } from '../utils/ssrf-guard.js';
describe('SSRF Guard', () => {
    describe('validateUrlForSSRF', () => {
        ...
        describe('allows valid URLs', () => {
            it('allows https://api.google.com', () => {
                expect(validateUrlForSSRF('https://api.google.com/v1').allowed).toBe(true);
            });
    ...
    describe('validateGeminiBaseUrl', () => {
        it('blocks internal IPs', () => {
            expect(validateGeminiBaseUrl('http://127.0.0.1:8080').allowed).toBe(false);
        });
        it('allows valid external URLs', () => {
            expect(validateGeminiBaseUrl('https://api.google.com').allowed).toBe(true);
        });
    });
});
