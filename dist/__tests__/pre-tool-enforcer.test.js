...
describe('pre-tool-enforcer fallback gating (issue #970)', () => {
    ...
    it('suppresses routine pre-tool reminders when OMG_QUIET=1', () => {
    ...
    it('keeps active-mode and team-routing enforcement visible when OMG_QUIET is enabled', () => {
    ...
    it('suppresses routine agent spawn chatter at OMG_QUIET=2 but not enforcement', () => {
