 ...
 */
export declare function getGeminiConfigDir(): string;
/**
 ...
 */
export declare function getLegacyOmgDir(): string;
/**
 ...
 */
export declare function getGlobalOmgConfigRoot(): string;
/**
 ...
 */
export declare function getGlobalOmgStateRoot(): string;
export declare function getGlobalOmgConfigPath(...segments: string[]): string;
export declare function getGlobalOmgStatePath(...segments: string[]): string;
export declare function getLegacyOmgPath(...segments: string[]): string;
export declare function getGlobalOmgConfigCandidates(...segments: string[]): string[];
export declare function getGlobalOmgStateCandidates(...segments: string[]): string[];
/**
