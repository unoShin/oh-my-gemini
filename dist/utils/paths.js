 ...
 */
export function getLegacyOmgDir() {
 ...
 */
export function getGlobalOmgConfigRoot() {
 ...
 */
export function getGlobalOmgStateRoot() {
    const explicitRoot = process.env.OMG_HOME?.trim();
    if (explicitRoot) {
...
export function getGlobalOmgConfigPath(...segments) {
    return join(getGlobalOmgConfigRoot(), ...segments);
}
export function getGlobalOmgStatePath(...segments) {
    return join(getGlobalOmgStateRoot(), ...segments);
}
export function getLegacyOmgPath(...segments) {
    return join(getLegacyOmgDir(), ...segments);
}
function dedupePaths(paths) {
    return [...new Set(paths)];
}
export function getGlobalOmgConfigCandidates(...segments) {
...
export function getGlobalOmgStateCandidates(...segments) {
    const explicitRoot = process.env.OMG_HOME?.trim();
    if (explicitRoot) {
        return dedupePaths([
