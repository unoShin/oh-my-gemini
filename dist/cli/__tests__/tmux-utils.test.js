...
describe('wrapWithLoginShell', () => {
    ...
    it('works with complex multi-statement commands', () => {
        vi.stubEnv('SHELL', '/bin/zsh');
        const cmd = 'sleep 0.3; echo hello; gemini --dangerously-skip-permissions';
