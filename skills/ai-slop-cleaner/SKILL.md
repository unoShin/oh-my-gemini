...
Use this skill to clean AI-generated code slop without drifting scope or changing intended behavior. In OMG, this is the bounded cleanup workflow for code that works but feels bloated, repetitive, weakly tested, or over-abstracted.
...
- Good fit: `oh-my-gemini:ai-slop-cleaner skills/ralph/SKILL.md skills/ai-slop-cleaner/SKILL.md`
...
- `/oh-my-gemini:ai-slop-cleaner <target>`
- `/oh-my-gemini:ai-slop-cleaner <target> --review`
- `/oh-my-gemini:ai-slop-cleaner <file-a> <file-b> <file-c>`
