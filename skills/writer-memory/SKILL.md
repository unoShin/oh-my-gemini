...
Writer Memory maintains context across Gemini sessions for fiction writers. It tracks:
...
| Command | Action |
|---------|--------|
| `/oh-my-gemini:writer-memory init <project-name>` | Initialize new project memory |
| `/oh-my-gemini:writer-memory status` | Show memory overview (character count, scene count, etc) |
| `/oh-my-gemini:writer-memory char add <name>` | Add new character |
| `/oh-my-gemini:writer-memory char <name>` | View character details |
| `/oh-my-gemini:writer-memory char update <name> <field> <value>` | Update character field |
| `/oh-my-gemini:writer-memory char list` | List all characters |
| `/oh-my-gemini:writer-memory rel add <char1> <char2> <type>` | Add relationship |
| `/oh-my-gemini:writer-memory rel <char1> <char2>` | View relationship |
| `/oh-my-gemini:writer-memory rel update <char1> <char2> <event>` | Add relationship event |
| `/oh-my-gemini:writer-memory scene add <title>` | Add new scene |
| `/oh-my-gemini:writer-memory scene <id>` | View scene details |
| `/oh-my-gemini:writer-memory scene list` | List all scenes |
| `/oh-my-gemini:writer-memory theme add <name>` | Add theme |
| `/oh-my-gemini:writer-memory world set <field> <value>` | Set world attribute |
| `/oh-my-gemini:writer-memory query <question>` | Query memory naturally (Korean supported) |
| `/oh-my-gemini:writer-memory validate <character> <dialogue>` | Check if dialogue matches character tone |
| `/oh-my-gemini:writer-memory synopsis` | Generate emotion-focused synopsis |
| `/oh-my-gemini:writer-memory export` | Export full memory as readable markdown |
| `/oh-my-gemini:writer-memory backup` | Create manual backup |
...
```
Task(subagent_type="oh-my-gemini:architect",
     model="opus",
