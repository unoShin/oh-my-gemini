...
Reusable skills are not code snippets to copy-paste, but **principles and decision-making heuristics** that teach Gemini HOW TO THINK about a class of problems.
...
- **User-level**: ~/.gemini/skills/omg-learned/ - Rare. Only for truly portable insights.
...
## The Approach
The decision-making heuristic, not just code. How should Gemini THINK about this?

## Example (Optional)
If code helps, show it - but as illustration of the principle, not copy-paste material.
```

**Key**: A skill is REUSABLE if Gemini can apply it to NEW situations, not just identical ones.
