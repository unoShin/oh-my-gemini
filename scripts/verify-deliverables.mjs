...
/**
 * OMG Deliverable Verification Hook (SubagentStop)
 *
 ...
 *   2. ${GEMINI_PLUGIN_ROOT}/templates/deliverables.json (OMG defaults)
 *
...
/**
 * Load deliverable requirements from project config or OMG defaults.
 */
...
/**
 * Determine the current team stage from OMG state.
 */
...
async function main() {
  try {
    ...
    const message = `[OMG] Deliverable verification for stage "${stage}":\n` +
