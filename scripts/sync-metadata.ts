...
function loadMetadata(): Metadata {
  ...
  return {
    ...
    npmPackage: packageJson.name || 'oh-my-gemini',
  };
}
...
function getFileSyncConfigs(): FileSync[] {
  ...
  return [
    ...
    },
    {
      ...
      replacements: [
        {
          pattern: /<!-- OMG:VERSION:[^\s]*? -->/g,
          replacement: (m) => `<!-- OMG:VERSION:${m.version} -->`,
          description: 'GEMINI.md version marker',
        },
      ],
    },
    {
...
${color('Files Synced:', colors.cyan)}
  ...
  - .github/GEMINI.md (agent/skill counts)
